...
def sal_preprocess(source_dir, files, ws, sample_num=250000, sigma=0.2):
    for f in tqdm(files):
        ...
        sal_dist_tringles = (ws.get_dir('sal_dist2tringles_dir')/f).with_suffix(f.suffix+'.npy')
        ...
        np.save(sal_norm, norm_params)

        # construct a triangle soup
...
if __name__ == '__main__':
    ...
    data_dir = '/home/syao/Program/Experiments/N3D/SAL_FAMILY/Data'
    base_dir = Path(data_dir)
    sub_dir = {
        'sal_pnts_dir': 'SalPnts',
        'sal_dist2tringles_dir': 'SalDist2Tringles',
